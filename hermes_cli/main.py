    ...
    try:
        ...
        try:
            ...
            if pull_result.returncode != 0:
                ...
                # discard committed work merely because the updater's
                # fast-forward precondition failed.
                ...
                print(
                    "  Inspect with: git status && git log --oneline --graph "
                    "--decorate --all -20"
                )
                print(
                    "  Rebase or merge explicitly after creating a backup branch."
                )
                sys.exit(1)
